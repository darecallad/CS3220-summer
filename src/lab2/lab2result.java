...
/**
 * Servlet implementation class lab2result
 */
@WebServlet("/lab2result")
public class lab2result extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        double per2 = counter2 / total * 100;
				...
				out.println("<img img src =\"https://upload.wikimedia.org/wikipedia/en/thumb/d/d8/Game_of_Thrones_title_card.jpg/250px-Game_of_Thrones_title_card.jpg\" alt =\"Game of Throne\" id=\"0\" width= \"270\" height= \"170\">");
				out.println("<table>");
				out.println("<tr>");
